...
FlowRouter.route('/reset_pass_link', {
    name: 'reset_pass',
    action() {
      BlazeLayout.render('MainLayout', {main: 'ResetPassLinkLayout', nav: 'Navbar'});
    }
});
...
FlowRouter.route('/reset-password/:token', {
    ...
    name: 'reset_pass',
    action() {
      BlazeLayout.render('MainLayout', {main: 'ResetPassLayout', nav: 'Navbar'});
    }
});
...
FlowRouter.route('/operatorDashboard/:customer', {
    triggersEnter: [function(context, redirect) {
      ...
      console.log(Meteor.userId())
      if(Meteor.userId() == null) // Role checking in "SecureDashboardLink" in client main.js
        redirect('/');
      }],
    name: 'home',
    action(params) {
